            ...
            $.each(data, function(key, sismo) {   //generate list
             ...
             var marker = new MarkerWithLabel({
              ...
              google.maps.event.addListener(marker, 'mouseover', function(){
                var note = 'Sismo: ' + this.title + ' Grados';
                if(!popup){
              ...
              centro = new google.maps.LatLng(sumaLat/suma,sumaLng/suma);
              map.setCenter(centro);
          });

      responsiveDesign(map);


        }
      // Responsive Design gmap api v3
      function responsiveDesign(map) {
